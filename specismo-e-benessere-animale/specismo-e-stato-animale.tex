...
moderno, suggerì in un'intervista\footnote{P. Singer, in ``The Vegan'' 2007.}
che si tratti di un'azione moralmente giustificabile:
...
che ci portano a danneggiarci o a danneggiare gli altri, ma questo non è certo
un segno dell'irrazionalità di \emph{tutte} le emozioni; è semplicemente frutto
della natura limitata dell'essere umano, che tende all'errore e al pregiudizio
in ogni campo, nelle emozioni così come nell'etica morale.

% Se le emozioni non sono razionali, non si possono usare per l'etica.

\chapter{Il diritto di avere diritti}

Gli animalisti parlano spesso di diritti degli animali. Ma come vedremo, gli
animali non hanno diritto ad avere diritti. Per avere dei diritti, bisogna
essere in grado di rispettare dei doveri. L'unico motivo per cui un essere umano
ha il diritto alla vita è che può rispettare il dovere di non uccidere.
...
specie: uccidere un cane non è una violazione del suo diritto alla vita ma
